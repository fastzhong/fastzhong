...
source $( cd -P -- "$(dirname -- "$(command -v -- "$0")")" && pwd -P )/setmq-lc.sh
...
uecs_port=7671
domestic_port=7633
domestic_payroll_port=7634
managebatch_port=7673
bulk_process_port=7615
cna_bank_port=8031
aqs_port=7644
...
file_upload_nfs_directory=/CEWTH/BULK/Outgoing/attachment_LC/
export file_upload_lc=true
...
# NFS
nfs_attachment_directory=/CEWTH/BULK/Outgoing/attachment_LC/
done_nfs_directory=/CEWTH/BULK/Outgoing/processing_LC/
ccti_nfs_attachment_directory=/CEWTH/BULK/Outgoing/attachment_LC/
ccti_done_nfs_directory=/CEWTH/BULK/Outgoing/processing_LC/
dmpIncomingProcessingFilePath=/CEWTH/BULK/Incoming/processing_LC/
dmpIncomingProcessingFATEFilePath=/CEWTH/BULK/Incoming/FATE_LC/
dmpIncomingBackupFilePath=/CEWTH/BULK/Incoming/backup/
dmpIncomingErrorFilePath=/CEWTH/BULK/Incoming/error/
bulkprocess_dmpIncomingProcessingFilePath=/CEWTH/BULK/Incoming/processing_LC/
...
ccti_dmpIncomingProcessingFATEFilePath=/CEWTH/BULK/Incoming/FATE_LC/
...
rosBulkIncomingFATEFilePath=/CEWTH/BULK/Incoming/FATE_LC/
rosBulkIncomingACKFilePath=/CEWTH/BULK/Incoming/FATE_LC/
